...
let recipeCont = document.querySelector('#recipe-list');
...
function recipeTemplate(recipe) {
    return `<section id=${recipe.name.toLowerCase().replaceAll(" ", "-")} class="recipe">
        <div class="photo">
        ...
        <div class="recipe-content">
            ...
            <p class="description">${recipe.description}</p></div>
...
function tagTemplate(tags) {
    ...
    tags.forEach(tag => {html += `<li class="tag">${tag}</li>`})
...
function renderRecipe(recipe) {
    ...
    recipeCont.innerHTML += html

}

function init() {
    renderRecipe(recipes[Math.floor(Math.random() * recipes.length)]);
}
